...
export default {
  ...
  methods: {
    ...
    submitCampaign() {
      ...
      const dataCollaborator = this.collaborators.map((e) => e)
      console.log(dataCollaborator, typeof dataCollaborator, typeof this.collaborators)
      ...
      data.append('collaborators', this.collaborators)
